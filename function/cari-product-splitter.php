...
if (isset($_POST['keyword'])) {
    ...
    $query = "SELECT * FROM tb_product WHERE kategori_product = 'Splitter' AND (nama_product LIKE '%$keyword%' OR merek_product LIKE '%$keyword%' OR harga_product LIKE '%$keyword%') ORDER BY harga_product ASC";
