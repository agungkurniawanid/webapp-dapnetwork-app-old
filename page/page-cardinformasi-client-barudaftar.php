...
$SELECT_DATA = "SELECT * FROM tb_client WHERE MONTH(tanggal_masuk) = MONTH(CURDATE())";
...
<body>
    <div class="container-page-penagihan">
        <div class="btnkembali-heading">
            ...
            <div class="heading">Client Baru Daftar</div>
        </div>
        <?php if (mysqli_num_rows($RESULT_DATA) > 0) : ?>
            <?php include '../components/card/card-daftarclient-barudaftar.php' ?>
        <?php else : ?>
