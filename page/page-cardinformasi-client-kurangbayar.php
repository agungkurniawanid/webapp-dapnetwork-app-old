...
$SELECT_DATA = "SELECT * FROM tb_client JOIN tb_pembayaran ON tb_client.id_client = tb_pembayaran.id_client WHERE tb_pembayaran.status_pembayaran = 'Kurang Bayar' AND MONTH(tb_pembayaran.tanggal_pembayaran) = MONTH(CURRENT_DATE())";
...
<body>
    <div class="container-page-penagihan">
        <div class="btnkembali-heading">
            ...
            <div class="heading">Client Kurang Bayar</div>
        </div>
        <?php if (mysqli_num_rows($RESULT_DATA) > 0) : ?>
            <?php include '../components/card/card-daftarclient-kurangbayar.php' ?>
        <?php else : ?>
