...
$SELECT_DATA = "SELECT * FROM tb_client WHERE status_client = 'Tidak aktif'";
...
<body>
    <div class="container-page-penagihan">
        <div class="btnkembali-heading">
            ...
            <div class="heading">Client Baru Minggu Ini</div>
        </div>
        <?php if (mysqli_num_rows($RESULT_DATA) > 0) : ?>
            <?php include '../components/card/card-daftarclient-tidakaktif.php' ?>
        <?php else : ?>
