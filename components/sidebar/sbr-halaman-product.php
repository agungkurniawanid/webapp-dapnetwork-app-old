...
<html lang="in-ID">
  <head>
    ...
    <link rel="stylesheet" href="css/sbr-halaman-product.css" />
  </head>
    ...
    <div class="sub-wrapper-sidebar" id="sub-wrapper-sidebar">
      ...
      <div class="menu-item-sidebar">
        <ul>
          <li
            id="menu-dashboard"
            onclick="window.location.href = 'dsb-halaman-utama.php'"
          ...
          >
            <img src="svg/menu-product-hover.svg" alt="icon" />&nbsp; Product
          </li>
          <li
            id="menu-pegawai"
