    ...
    <div class="sub-wrapper-sidebar" id="sub-wrapper-sidebar">
        ...
        <div class="menu-item-sidebar">
            <ul>
                ...
                <li id="menu-pegawai" onclick="window.location.href = 'dsb-halaman-pegawai.php'" onmouseover="changeIconPegawai(this, true) " onmouseout="changeIconPegawai(this,false)">
                    <img src="svg/menu-pegawai-hover.svg" alt="icon" />&nbsp; Pegawai
                </li>
                <li id="menu-paket" onclick="window.location.href = 'dsb-paket-layanan.php'" onmouseover="changeIconPaket(this, true)" onmouseout="changeIconPaket(this,false)">
                    <img src="svg/menu-service.svg" alt="icon" />&nbsp; Paket Layanan
                </li>
                <li id="menu-pemasukan" onclick="window.location.href = 'dsb-halaman-pemasukan.php'" onmouseover="changeIconPemasukan(this, true)" onmouseout="changeIconPemasukan(this,false)">
                    <img src="svg/menu-pemasukan.svg" alt="icon" />&nbsp; Pemasukan
                </li>
                <li id="menu-pengeluaran" onclick="window.location.href = 'dsb-halaman-pengeluaran.php'" onmouseover="changeIconPengeluaran(this, true)" onmouseout="changeIconPengeluaran(this,false)">
                    <img src="svg/menu-pengeluaran.svg" alt="icon" />&nbsp; Pengeluaran
                </li>
                <li id="menu-transaksi" onclick="window.location.href = 'dsb-halaman-transaksi.php'" onmouseover="changeIconSetting(this, true)" onmouseout="changeIconSetting(this,false)">
