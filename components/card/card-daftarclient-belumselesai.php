...
$FECTH_DATA = "SELECT * FROM tb_client JOIN tb_pemesanan ON tb_client.id_client = tb_pemesanan.id_client WHERE tb_pemesanan.status_pemesanan_instalasi = 'Belum selesai' AND MONTH(tb_pemesanan.tanggal_pesan_instalasi) = MONTH(CURRENT_DATE());";
