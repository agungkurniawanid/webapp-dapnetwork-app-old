...
$FECTH_DATA = "SELECT * FROM tb_client JOIN tb_pembayaran ON tb_pembayaran.id_client = tb_client.id_client WHERE tb_pembayaran.status_pembayaran = 'Kurang Bayar' AND MONTH(tb_pembayaran.tanggal_pembayaran) = MONTH(CURRENT_DATE())";
