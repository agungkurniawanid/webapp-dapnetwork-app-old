...
const btnClose = document.getElementById("closeInsertPengeluaran");
const btnShowFormPegawai = document.getElementById("btn-tambah-pengeluaran");
const overlayFormPegawai = document.querySelector(".overlay-page-pengeluaran");
const formPegawai = document.querySelector(".modal-page-pengeluaran");
